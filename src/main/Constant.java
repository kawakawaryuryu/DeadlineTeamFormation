...
public class Constant {
	/* Main */
	public static final int AGENT_NUM = 300;	//エージェント数
	public static final int TURN_NUM = 500000;	//実行ターン数
	public static final double ADD_TASK_PER_TURN = 2;	//1ターンあたりに追加する平均タスク数
	public static final int ADD_TASK_PER_TURN_LATTER = 6;	//後半から1ターンあたりに追加する平均タスク数
	public static final int ALWAYS_TASK_NUM = 5;	//常にキューに一定数のタスクを存在させたときのタスク数
	...
	public static final int DEADLINE_MAX_LATTER = 2;	//後半から変えるデッドラインの最大値
	public static final int DEADLINE_INIT_LATTER = 3;	//後半から変えるデッドラインの初期値
...
//	public static final double initialGreedy = Administrator.greedy_random.nextDouble();	//欲張り度の初期値
	...
	public static final int MEASURE_TURN_NUM = 500;	//処理、廃棄リソース量の計測ターン数
	public static final int MEASURE_Q_TURN_NUM = 25000;	//Q値の計測ターン数
	public static final int MEASURE_Q_INIT_TURN_NUM = 25000;
	public static final int MEASURE_VISUALIZATION_TURN_NUM = 100000;	//可視化のための結果の計測ターン
	public static final int MEASURE_SUCCESS_AT_END_TURN_NUM = 10000;	//チーム編成成功回数を計測する最後のターン数
	public static final int MEASURE_STATE_TURN_NUM = 10;	//エージェントが暇or忙しいエージェント数の計ターン数
	
	public static final int WAIT_TURN = 10;	//各状態における待機ターン
	
	/* エージェントの状態 */
	public static final int INITIAL_STATE = 0;	//初期状態
	public static final int LEADER_STATE  = 1;	//リーダ状態
	public static final int MEMBER_STATE  = 2;	//メンバ状態
	public static final int EXECUTE_STATE = 3;	//実行状態
	
	public static final int FREE_STATE = 0;	//暇なエージェント
	public static final int BUSY_LEADER_OR_MEMBER_STATE = 1;	//忙しいエージェント（リーダorメンバ状態）
	public static final int BUSY_WORK_STATE = 2;	//忙しいエージェント（実行状態）
	public static final int STATE_NUM = 3;	//上記のエージェントの状態数
	...
	public static int taskRequireLcm(){
		int lcmNum = lcm(Constant.AGENT_ABILITY_INIT, Constant.AGENT_ABILITY_INIT + 1);
		for(int i = Constant.AGENT_ABILITY_INIT + 2; i < Constant.AGENT_ABILITY_MAX + Constant.AGENT_ABILITY_INIT - 1; i++){
			lcmNum = lcm(i, lcmNum);
		}
		return lcmNum;
	}
