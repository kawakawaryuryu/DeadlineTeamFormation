 ...
 */
public class RandomRoleSelectStrategy3 implements InitialRoleSelectStrategy {
	...
	public double calculateExpectedLeaderReward(Agent agent, Task task) {
		...
		double expectedTeamResources = 0.0;	//平均チームリソース
...
//		System.out.println("エージェント" + agent + "がサブタスク" + subtask + "の処理にかかる時間 = " + executeTime);
	...
	public String toString(){
		return "ランダムな戦略（1tickごとの報酬期待度で学習＋チーム履歴なし）";
	}
}
